...
\begin{frame}\frametitle{SBR: contribution plot for batch 37}
	...
	\begin{itemize}
		\item	Contributions highest for the latex density and conversion, as expected.
				...
				\begin{itemize}
					\item	{\color{myGreen}{\texttt{{\color{myOrange}{\texttt{  contrib\_37 = contrib(batch\_PCA, 37)  }}}}}
					
					\item	{\color{myGreen}{\texttt{{\color{myOrange}{\texttt{  plot(contrib\_37, 'scores', 1)		  }}}}}
				\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{SBR: raw data for batch 37 (to confirm)}
	...
	\begin{itemize}
		\item	Confirmed our interpretation with the raw data
				...
				\begin{itemize}
					\item	{\color{myGreen}{\texttt{{\color{myOrange}{\texttt{  plot(batch\_PCA.X, 'highlight', 2, 3, 37)		  }}}}}
